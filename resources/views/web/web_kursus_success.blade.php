                                    ...
                                    <div data-marker-id="59c0c8e322f3375db4d89128" class="col-sm-6 col-xl-4 mb-5 hover-animate">
                                        <div class="card card-kelas h-100 border-0 shadow">
                                            <div class="card-img-top overflow-hidden gradient-overlay">
                                                ...
                                                <div class="card-img-overlay-bottom z-index-20">
                                                    <div class="media text-white text-sm align-items-center">
                                                        ...
                                                        <img src="{{ asset('uploads/tutor/'.$tutor->foto) }}" alt="{{ $tutor->nama_tutor }}" class="avatar-profile avatar-border-white mr-2" />
                                            ...
                                            <div class="card-body d-flex align-items-center">
                                                <div class="w-100">
                                                    <h6 class="card-title"><a href="{{ route('user.kursus.kelas',$cours->slug) }}" class="text-decoration-none text-dark">{{ $cours->nama_kursus }}</a></h6>
                                                    ...
                                                    <span class="badge badge-success text-light float-right"><i class="fas fa-check-circle"></i> Aktif</span>
                                                    {{-- <p class="card-text text-muted"><span class="h5 text-primary">@currency($row->biaya_kursus)</span> per
                                                        Bulan</p>
                                                    <p class="card-text text-muted">Dipotong diskon <span class="h6 text-danger"> {{ $cours->diskon_kursus }}%</span> </p> --}}
                                                    
                                                    @if ($cours->diskon_kursus == 0)     
                                                        <p class="card-text text-muted"><span class="h4 text-primary"> @currency($row->biaya_kursus)</span>
                                                            per Bulan</p>                                        
                                                        @else
                                                        <p class="card-text text-muted">
                                                            <span class="h4 text-primary"> @currency($cours->biaya_kursus - ($cours->biaya_kursus * ($cours->diskon_kursus/100)))</span>
                                                            per Bulan
                                                        </p> 
                                                        <p class="card-text ">
                                                            <strike>
                                ...
                                {{-- @elseif($item->status_kursus == "PENDING")
                                    ...
                                    <div data-marker-id="59c0c8e322f3375db4d89128" class="col-sm-6 col-xl-4 mb-5 hover-animate">
                                        <div class="card card-kelas h-100 border-0 shadow">
                                            ...
                                            <div class="card-body d-flex align-items-center">
                                                <div class="w-100">
                                                    <h6 class="card-title"><a href="{{ route('front.detail',$cours->slug) }}" class="text-decoration-none text-dark">{{ $cours->nama_kursus }}</a></h6>
                                                    <div class="d-flex card-subtitle mb-3">
                                                        <p class="flex-grow-1 mb-0 text-muted text-sm">{{ $cours->keterangan }}</p>
                                                        <p class="flex-shrink-1 mb-0 card-stars text-xs text-right"><i
                                                                class="fa fa-star text-warning"></i><i
                                                    ...
                                                    <span class="badge badge-secondary text-light float-right"><i class="fas fa-spinner"></i></i> Pending</span>
                                                    <p class="card-text text-muted"><span class="h5 text-primary">@currency($cours->biaya_kursus)</span> per
                                                        Bulan</p>
                                                    <p class="card-text text-muted">Dipotong diskon <span class="h6 text-danger"> {{ $cours->diskon_kursus }} <i class="fas fa-percent"></i> </span> </p>
