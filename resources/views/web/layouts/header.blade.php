        ...
        <div class="container-fluid">
            ...
            <div id="navbarCollapse" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="{{ route('front.kursus') }}" class="nav-link active">List Kursus</a>
                    </li>
                    ...
                    <li class="nav-item"><a href="{{ route('user.logout') }}"
                            class="nav-link badge badge-primary mt-1 text-light">Log Out</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-2 d-flex align-items-center form-group">
                    <div class="input-label-absolute input-label-absolute-right w-100">
                        ...
                        <input type="text" name="location" placeholder="Lokasi" class="form-control border-0 shadow-0">
                    </div>
                </div>

                <div class="col-md-6 col-lg-3 d-flex align-items-center form-group no-divider">
                    <form action="{{ route('front.index') }}">
                        <select id="nama_kategori" name="nama_kategori" data-style="btn-form-control"
