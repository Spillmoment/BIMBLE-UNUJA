        ...
        {{-- <div class="col-lg-9">
            <div class="row">
                <form>
                    ...
                    <button type="button" data-slug="{{ $kursus->slug }}" id="komen" class="btn btn-primary">Submit</button>
                </form>
        ...
        <div class="col-md-12">
            <div class="row">
                <form action="/user/kursus/{{ $kursus->slug }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Komentar</label>
                        <textarea class="form-control @error('textkomen') is-invalid @enderror" name="textkomen" id="textkomen" rows="3"></textarea>
                        @error('textkomen')
