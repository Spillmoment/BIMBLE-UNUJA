...
<input value="{{old('stock')}}" type="number" class="form-control {{$errors->first('stock') ? "is-invalid" : ""}} " id="stock"
...
<input value="{{old('price')}}" type="number" class="form-control {{$errors->first('price') ? "is-invalid" : ""}} " name="price"
...
<br>
    ...
    <link rel="stylesheet" href="{{asset('polished/select2/select2.min.css')}}">
    <script src="{{ asset('polished/select2/select2.min.js') }}"></script>
