                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">Gambar Kursus :
                            <img class="card-img-top" src="{{ asset('uploads/kursus/'.$kursus->gambar_kursus) }}"
                                alt="Card image cap" style="width: 8rem">
                    ...
                    <div class="card-body">
                        <a href="{{ route('kursus.index') }}" class="card-link btn btn-primary text-light"> <i
