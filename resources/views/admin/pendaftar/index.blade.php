                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-5 col-xs-5">
                        <div class="form-group">
                            <input type="text" class="form-control" {{ Request::get('keyword') }} name="keyword"  placeholder="Masukkan Nama" autofocus>
                        </div>
                    </div>
                            <div class="col-md-3">
                                <button type="submit" class="btn btn-secondary"> <i class="fa fa-search" aria-hidden="true"></i> </button>
                                <a href="{{ route('pendaftar.index') }}" class="btn btn-warning text-light ml-2"> <i class="fa fa-refresh" aria-hidden="true"></i> </a>
                            </div>
                ...
                <table class="table table-hover">
                  <thead>
                        ...
                        <tbody>
                            ...
                            <td>
                                @if($regis->foto) 
                                    <img src="{{ Storage::url('uploads/pendaftar/profile/'.$regis->foto) }}" width="50px"> 
                                    @else
                                    N/A
                                    @endif
                                </td>   
